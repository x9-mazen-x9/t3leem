    ...
    <div className="dashboard-container" dir="rtl">
      ...
      <aside className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
        <div className="sidebar-header">
          <h2 className="logo" style={{ fontSize: '1.5rem' }}>MAJMA</h2>
      ...
      <main className="main-content">
        {/* Header */}
        <header className="dashboard-header glass-card" style={{ borderRadius: '0', padding: '15px 30px', display: 'flex', justifyContent: 'space-between' }}>
